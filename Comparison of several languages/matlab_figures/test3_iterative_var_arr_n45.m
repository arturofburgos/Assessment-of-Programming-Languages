...
% FILE'S NAME TO SAVE
%--------------------------------------------------------------------------
SIMPATH.savefile = '../Figures/3rd_iterative_var_arr_n45';
...
%--------------------------------------------------------------------------
n = 1;
SIMPATH.file(n).path = '../Data/3rd_iterative_var_arr_n45.txt'; n=n+1; % Diretorio para acessar
SIMPATH.file(n).path = '../Data/3rd_iterative_var_arr_n45.txt'; n=n+1; % Diretorio para acessar
SIMPATH.file(n).path = '../Data/3rd_iterative_var_arr_n45.txt'; n=n+1; % Diretorio para acessar
SIMPATH.file(n).path = '../Data/3rd_iterative_var_arr_n45.txt'; n=n+1; % Diretorio para acessar
SIMPATH.file(n).path = '../Data/3rd_iterative_var_arr_n45.txt'; n=n+1; % Diretorio para acessar
...
SIMPATH.file(n).line2plot = [6]; n=n+1; % Columns to be ploted for file 2
%--------------------------------------------------------------------------
...
n = 1;
FIGOPT.file(n).legend = 'Python (A)'        ; n=n+1;
FIGOPT.file(n).legend = 'Python (V)'        ; n=n+1;
FIGOPT.file(n).legend = 'Julia (A)'         ; n=n+1;
FIGOPT.file(n).legend = 'Julia (B)'         ; n=n+1;
FIGOPT.file(n).legend = 'Fortran (A)'       ; n=n+1;
FIGOPT.file(n).legend = 'Fortran (B)'       ; n=n+1;
%--------------------------------------------------------------------------

...
% FILE'S NAME TO SAVE
%--------------------------------------------------------------------------
SIMPATH.savefile = '../Figures/2st_vectorization_n1500_python1500';
...
%--------------------------------------------------------------------------
n = 1;
SIMPATH.file(n).path = '../Data/2st_vectorization_n1500_python1500.txt'; n=n+1; % Diretorio para acessar
SIMPATH.file(n).path = '../Data/2st_vectorization_n1500_python1500.txt'; n=n+1; % Diretorio para acessar
SIMPATH.file(n).path = '../Data/2st_vectorization_n1500_python1500.txt'; n=n+1; % Diretorio para acessar
SIMPATH.file(n).path = '../Data/2st_vectorization_n1500_python1500.txt'; n=n+1; % Diretorio para acessar
%SIMPATH.file(n).path = '../Data/2st_vectorization_n1500_python1500.txt'; n=n+1; % Diretorio para acessar

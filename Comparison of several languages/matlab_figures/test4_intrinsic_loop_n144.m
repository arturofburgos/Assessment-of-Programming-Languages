...
% FILE'S NAME TO SAVE
%--------------------------------------------------------------------------
SIMPATH.savefile = '../Figures/4th_intrinsic_loop_n144';
...
%--------------------------------------------------------------------------
n = 1;
SIMPATH.file(n).path = '../Data/4th_intrinsic_loop_n144.txt'; n=n+1; % Diretorio para acessar
SIMPATH.file(n).path = '../Data/4th_intrinsic_loop_n144.txt'; n=n+1; % Diretorio para acessar
%SIMPATH.file(n).path = '../Data/4th_loop_n1024.txt'; n=n+1; % Diretorio para acessar
%SIMPATH.file(n).path = '../Data/4th_loop_n1024.txt'; n=n+1; % Diretorio para acessar
%SIMPATH.file(n).path = '../Data/4th_loop_n1024.txt'; n=n+1; % Diretorio para acessar
%--------------------------------------------------------------------------
...
FIGOPT.file(n).legend = 'intrinsic'  ; n=n+1;
FIGOPT.file(n).legend = 'loop'       ; n=n+1;

...
% FILE'S NAME TO SAVE
%--------------------------------------------------------------------------
SIMPATH.savefile = '../Figures/5th_file_n1000000';
...
%--------------------------------------------------------------------------
n = 1;
SIMPATH.file(n).path = '../Data/5th_file_n1000000.txt'; n=n+1; % Diretorio para acessar
SIMPATH.file(n).path = '../Data/5th_file_n1000000.txt'; n=n+1; % Diretorio para acessar
SIMPATH.file(n).path = '../Data/5th_file_n1000000.txt'; n=n+1; % Diretorio para acessar
SIMPATH.file(n).path = '../Data/5th_file_n1000000.txt'; n=n+1; % Diretorio para acessar
%SIMPATH.file(n).path = '../Data/4th_loop_n144.txt'; n=n+1; % Diretorio para acessar
%--------------------------------------------------------------------------
